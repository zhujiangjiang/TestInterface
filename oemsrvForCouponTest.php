...
while($loop)
{
    ...
    $rs = socket_connect($socket,'192.168.0.250',3001);
...
//1000000274 7300000115
      $str = "007KA_B2B~1.0.0.2~5~1000000007~100000000000007~$orderid~$mob~5000~~~$now~001~177442702089177049~~2~";
  ...
  //  $str = "007KA_B2B~1.0.0.1~1~1777777777~100000777777777~$orderid~$mob~-5000~~~$now~1~";
    ...
    //$sign = strtoupper(md5($str . 'FApuc8/x23P/fgcFHg0RfzJnYrY5nJV4'));
    $str .= $sign;
